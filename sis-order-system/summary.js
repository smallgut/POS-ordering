...
async function loadOrders(startDate = '', endDate = '', categoryFilter = '') {
    ...
    const categoryMap = {
        '蔬果類': ['麻糬茄子', '茄子', '芹菜', /* ... other veg items ... */, '檸檬', '柳丁', /* ... other fruit items ... */],
        '鮮肉類': ['豬絞肉', '梅花豬', /* ... other meat items ... */],
        '海鮮類': ['白蝦', '草蝦', /* ... other seafood items ... */],
        '其他類': ['肉羹', '肉鬆', /* ... other items ... */, '紅油蔥', '蒜花生', /* ... other misc items ... */]
    };
...
async function updateCredentials() {
    ...
    try {
        ...
        // Optionally redirect to login again
